...
2. Fork https://github.com/ingenuity-build
3. Create a file gentx-{{VALIDATOR_NAME}}.json under the `mainnet/gentxs` folder in the forked repo, paste the copied text into the file.
