...
```
wget -O upgrade.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/quicksilver/innuendo/upgrade/136750/upgrade.sh && chmod +x upgrade.sh && ./upgrade.sh
```
