...
# sei node setup for Testnet — sei-devnet-1
...
```
wget -O sei.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/sei/sei-devnet-1/sei.sh && chmod +x sei.sh && ./sei.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/kj89/testnet_manuals/blob/main/sei/sei-devnet-1/manual_install.md) if you better prefer setting up node manually
...
### Fund your wallet
To top up your wallet join [Sei discord server](https://discord.gg/sPsUN6ay) and navigate to **#sei-devnet-1-faucet** channel
