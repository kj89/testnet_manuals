...
# Generate Gentx for sei sei-devnet-1
...
echo "export CHAIN_ID=sei-devnet-1" >> $HOME/.bash_profile
...
3. Create a file `{VALIDATOR_NAME}.json` under the `testnet/atlantic-subchains/sei-devnet-1/gentx` folder in the forked repo, paste the copied text into the file.
