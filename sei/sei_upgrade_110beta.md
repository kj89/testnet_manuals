...
```
wget -O sei_upgrade_110beta.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/sei/tools/sei_upgrade_110beta.sh && chmod +x sei_upgrade_110beta.sh && ./sei_upgrade_110beta.sh
```
