...
```
wget -O upgrade.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/sei/atlantic-sub-1/upgrade/2344300/upgrade.sh && chmod +x upgrade.sh && ./upgrade.sh
```
