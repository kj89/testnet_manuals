...
```
wget -O sei_upgrade_111beta.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/sei/tools/sei_upgrade_111beta.sh && chmod +x sei_upgrade_111beta.sh && ./sei_upgrade_111beta.sh
```
