...
| KEY |VALUE |
|---------------|-------------|
| **bond_denom** | Denominated token name, for example, `ustrd` for rebus mainnet. You can find it in genesis file |
...
To add validator use command with specified `VALIDATOR_IP`, `REBUS_VALOPER_ADDRESS`, `REBUS_WALLET_ADDRESS` and `PROJECT_NAME`
```
$HOME/cosmos_node_monitoring/add_validator.sh VALIDATOR_IP REBUS_VALOPER_ADDRESS REBUS_WALLET_ADDRESS PROJECT_NAME
```

> example: ```$HOME/cosmos_node_monitoring/add_validator.sh 1.2.3.4 rebusvaloper1zyyz4m9ytdf60fn9yaafx7uy7h463n7alv2ete rebus1zyyz4m9ytdf60fn9yaafx7uy7h463n7a05eshc rebus```
