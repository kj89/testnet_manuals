...
cd $HOME && rm -rf gravity
git clone https://github.com/Gravity-Labs/gravity.git && cd gravity
git checkout 4ec1b0ca818561cef04f8e6df84069b14399590e
make build
sudo mv build/gravityd $(which gravityd)
sudo systemctl restart gravityd && journalctl -fu gravityd -o cat
```
...
```
wget -O upgrade.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/gravity/upgrade/155420/upgrade.sh && chmod +x upgrade.sh && ./upgrade.sh
```
