...
```
wget -O archway_docker.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/archway/archway_docker.sh && chmod +x archway_docker.sh && ./archway_docker.sh
```
