...
yq -i '.services.validator.image = "${VALIDATOR_IMAGE_REPO:-aptoslabs/validator}:${IMAGE_TAG:-testnet_8141a975f9e7d831e9699c58a83724ac9635d991}"' docker-compose.yaml
...
yq -i '.services.fullnode.image = "${VALIDATOR_IMAGE_REPO:-aptoslabs/validator}:${IMAGE_TAG:-testnet_8141a975f9e7d831e9699c58a83724ac9635d991}"' docker-compose.yaml
