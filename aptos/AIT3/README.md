...
yq -i '.services.validator.image = "${VALIDATOR_IMAGE_REPO:-aptoslabs/validator}:${IMAGE_TAG:-testnet_26ed95ce4c8798743e7900bba566d29079af0a70}"' docker-compose.yaml
...
yq -i '.services.fullnode.image = "${VALIDATOR_IMAGE_REPO:-aptoslabs/validator}:${IMAGE_TAG:-testnet_26ed95ce4c8798743e7900bba566d29079af0a70}"' docker-compose.yaml
