...
| KEY |VALUE |
|---------------|-------------|
| **bond_denom** | Denominated token name, for example, `auptick` for uptick uptick testnet. You can find it in genesis file |
| **bench_prefix** | Prefix for chain addresses, for example, `uptick` for uptick uptick testnet. You can find it in public addresses like this **uptick**_valoper1zyyz4m9ytdf60fn9yaafx7uy7h463n7alv2ete_ |
