...
# gaia node setup for testnet — cosmoshub-4

Official documentation:
>- [Validator setup instructions](https://github.com/gaia-Labs/testnet)

Explorer:
>-  https://testnet.gaia.explorers.guru/
...
To top up your wallet join [gaia discord server](https://discord.gg/8F59kZfw) and navigate to:
