...
```
wget -O upgrade.sh https://raw.githubusercontent.com/kj89/testnet_manuals/main/hypersign/upgrade/667000/upgrade.sh && chmod +x upgrade.sh && ./upgrade.sh
```
