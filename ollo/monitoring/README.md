...
# Set up monitoring and alerting for ollo validator
...
| KEY |VALUE |
|---------------|-------------|
| **bond_denom** | Denominated token name, for example, `utollo` for ollo testnet. You can find it in genesis file |
...
To add validator use command with specified `VALIDATOR_IP`, `OLLO_VALOPER_ADDRESS`, `OLLO_WALLET_ADDRESS` and `PROJECT_NAME`
```
$HOME/cosmos_node_monitoring/add_validator.sh VALIDATOR_IP OLLO_VALOPER_ADDRESS OLLO_WALLET_ADDRESS PROJECT_NAME
```

> example: ```$HOME/cosmos_node_monitoring/add_validator.sh 1.2.3.4 ollovaloper1zyyz4m9ytdf60fn9yaafx7uy7h463n7alv2ete ollo1zyyz4m9ytdf60fn9yaafx7uy7h463n7a05eshc ollo```
