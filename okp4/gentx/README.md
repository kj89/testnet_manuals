...
echo "export CHAIN_ID=okp4-nemeton-1-1" >> $HOME/.bash_profile
...
okp4d add-genesis-account $WALLET_ADDRESS 10000200000uknow
```

## Generate gentx
```
okp4d gentx $WALLET 10000000000uknow \
--chain-id $CHAIN_ID \
--moniker=$NODENAME \
...
To register your validator node you just need to provide a signed `gentx` in a [⚖️ Register Validator issue](https://github.com/okp4/networks/issues).
